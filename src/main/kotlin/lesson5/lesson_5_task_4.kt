...
fun main() {
    ...
    if ((login == LOGIN) && (porol == POROL)) {
        println("Ваши данные проверены, входите в корабль HEART OF GOLD")
    } else {
        println("Вы вели не верные данные. Пройдите пожайлуста регистрацию тут")
